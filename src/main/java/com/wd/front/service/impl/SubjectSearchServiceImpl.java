...
@Service("subjectSearch")
public class SubjectSearchServiceImpl implements SearchServiceI{
	
	private static Logger logger = Logger.getLogger(SubjectListServiceImpl.class);
	...
	public SearchResult search(SearchCondition searchCondition) {
		...
		// 主查询
		SearchRequestBuilder mainSearchRequest = SearchRequestUtil.buildSearchRequestForSubject(false, searchCondition, queryStrategyContext, filterStrategyContext, facetBuilderStrategyContext,
