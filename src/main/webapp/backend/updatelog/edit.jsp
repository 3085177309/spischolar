...
<div class="wxcl_qq">
 <h4 style="color: red" id="msg">&nbsp;${error }</h4>
  <form name="qq_form" method="post" action="backend/updatelog/edit">
  	<input type="hidden" name="id" value="${log.id }" />
    <ul>
      <li class="tjxq_li1"><span>标&#12288;&#12288;题：</span>
        <input name="title" type="text" value="${log.title }" class="lg"/>
      </li>
      <li class="tjxq_li5" ><span>内&#12288;&#12288;容:</span>
      	<textarea rows="5" cols="100" class="ip_input1" name="content">${log.content }</textarea>
      </li>
      <li>
