...
<c:if test="${pager.total>10 }">
	...
	<div class="pagination" id='main_link_pg'>
		<ul>
			<pg:pager items="${pager.total}" url="backend/log/journalHomePage/${orgFlag }/${siteFlag }" export="cp=pageNumber" maxPageItems="10" maxIndexPages="10" idOffsetParam="offset">
...
<script>
$('#main_link_pg a').bind('click', function() {
