...
<c:if test="${pager.total>10 }">
	...
	<div class="pagination" id='doc_search_pg'>
		<ul>
			<pg:pager items="${pager.total}" url="backend/log/docTitleLog/${orgFlag }/${siteFlag }" export="cp=pageNumber" maxPageItems="10" maxIndexPages="10" idOffsetParam="offset">
...
<script>
$('#doc_search_pg a').bind('click', function() {
