...
<c:if test="${pager.total>10 }">
	...
	<div class="pagination" id='main_issn_pg'>
		<ul>
			<pg:pager items="${pager.total}" url="backend/log/issnLog/${orgFlag }/${siteFlag }" export="cp=pageNumber" maxPageItems="10" maxIndexPages="10" idOffsetParam="offset">
...
<script>
$('#main_issn_pg a').bind('click', function() {
