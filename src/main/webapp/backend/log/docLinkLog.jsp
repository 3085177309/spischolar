...
<c:if test="${pager.total>10 }">
	...
	<div class="pagination" id='doc_home_pg'>
		<ul>
			<pg:pager items="${pager.total}" url="backend/log/docHomePage/${orgFlag }/${siteFlag }" export="cp=pageNumber" maxPageItems="10" maxIndexPages="10" idOffsetParam="offset">
...
<script>
$('#doc_home_pg a').bind('click', function() {
