...
<div class="container"> 
  ...
  <c:set scope="request" var="menu" value="academic"></c:set>
  ...
  <div id="contentH" class="content" >
        ...
        <div class="tj_con" id="tj_con">
         <form method="get" action="backend/org/academic/list">
        <table width="100%">
        	<tr bgcolor="#f5f5f5">
        		<td>机构名称:</td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
  			<tr bgcolor="#f5f5f5">
    			<td width="25%"><b>学 校</b></td>
    			<td width="25%"><b>使用状态</b></td>
    			<td><b>时 间</b></td>
    			<td><b>操作</b></td>
  			</tr>
  			<c:forEach items="${orgPager.rows }" var="org" varStatus="status">
   			<tr>
				...
				<td>
					<a href="backend/org/resource/${org.orgFlag }">[资源配置]</a>
				</td>
   			</tr>
   			</c:forEach>
	</table>
	<div class="page">
		...
		<pg:pager items="${orgPager.total}" url="backend/org/academic/list" export="cp=pageNumber" maxPageItems="10" maxIndexPages="5" idOffsetParam="offset">
			<pg:param name="key" />
			<pg:prev>
