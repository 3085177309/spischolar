...
<div class="container"> 
  ...
  <c:set scope="request" var="menu" value="dnav"></c:set>
  ...
  <div id="contentH" class="content" >
        ...
        <form method="get" action="backend/org/dnav/list">
        <table width="100%">
        	<tr bgcolor="#f5f5f5">
        		<td>机构名称:</td>
	...
	<div class="page">
		...
		<pg:pager items="${orgPager.total}" url="backend/org/dnav/list" export="cp=pageNumber" maxPageItems="10" maxIndexPages="5" idOffsetParam="offset">
			<pg:param name="key" />
			<pg:prev>
