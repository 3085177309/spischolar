...
<c:if test="${not empty error }">
 <h4 style="color: red" id="msg">&nbsp;${error }</h4>
  ...
  <form name="qq_form" method="post" action="backend/page/edit">
  	<input type="hidden" name="id" value="${page.id }" />
    <ul>
      <li class="tjxq_li1"><span>标&#12288;&#12288;题：</span>
        <input name="title" type="text" value="${page.title }" class="lg"/>
      </li>
     <li class="tjxq_li1"><span>摘&#12288;&#12288;要：</span>
        <textarea name="intro" rows="4" cols="100">${page.intro }</textarea>
      </li>
      <li class="tjxq_li5" ><span>内&#12288;&#12288;容:</span>
      	<textarea rows="5" cols="100" class="ip_input1" name="content">${page.content }</textarea>
      </li>
      <li>
