					...
					<table class="data-table">
						...
						<c:forEach items="${list }" var="lists" varStatus="status">
							<tr>
								...
								<c:if test="${org.flag=='wdkj' }">
									<td><span><a
											href="<cms:getProjectBasePath/>backend/contentAnalysis/downloadRecord/info?title=${lists.titles}&school=${school}&beginTime=${beginTime}&endTime=${endTime}&type=${type}">查看明细</a></span></td>
								</c:if>
							</tr>
						</c:forEach>
					</table>
