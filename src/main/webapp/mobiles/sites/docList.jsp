...
<body>
	...
	// 排序功能
	;(function(){
		var sort_btn = $(".data-sort-hd li"),
			sort_popup = $(".data-sort-bd"),
			top = sort_popup.css("top");
		sort_btn.on('touchend',function(){
			...
			setTimeout(function(){
				...
				sort_popup.find("#sort_form ul").eq(index).show().siblings("ul").hide();
			},20)
		})

		sort_popup.on('touchend',function(){
			setTimeout(function(){
				sort_popup.css({height:0})
				sort_popup.find("#sort_form ul").hide();
			},20)
		})
	}())
</script>
