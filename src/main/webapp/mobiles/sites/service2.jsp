			...
			<div class="mui-scroll">
				...
				<div class="item-section">
					<div class="article-single">
						<h2>服务条款</h2>
						<p>欢迎您注册成为Spischolar学术资源在线用户！</p>
						<p>请仔细阅读下面的协议，只有接受协议才能继续进行注册。</p>

						<h3>1．服务条款的确认和接纳</h3>
						<p>Spischolar学术资源在线系统用户服务的所有权和运作权归湖南纬度信息科技有限公司所有。Spischolar学术资源在线所提供的服务将按照有关章程、服务条款和操作规则严格执行。用户通过注册程序勾选“我已经阅读并同意《用户服务条款》”，即表示用户与Spischolar学术资源在线达成协议并接受所有的服务条款。</p>
						...
						<p>Spischolar学术资源在线有权在必要时修改服务条款，服务条款一旦发生变动，将会在相关页面上提示修改内容。如果不同意所改动的内容，用户可以主动取消获得的网络服务。
							如果用户继续享用网络服务，则视为接受服务条款的变动。本服务系统保留随时修改或中断服务而不需知照用户的权利。本服务系统行使修改或中断服务的权利，不需对用户或第三方负责。</p>
						<h3>4．用户隐私制度</h3>
						<p>尊重用户个人隐私是Spischolar学术资源在线的基本政策。Spischolar学术资源在线不会公开、编辑或透露用户的邮件内容，除非有法律许可要求，或Spischolar学术资源在线在诚信的基础上认为透露这些信件在以下三种情况是必要的：
						</p>
						<ul>
							<li>（1）遵守有关法律规定，遵从合法服务程序。</li>
							<li>（2）保持维护Spischolar学术资源在线的商标所有权。</li>
						...
						<h3>7．有限责任</h3>
						<p>Spischolar学术资源在线对任何直接、间接、偶然、特殊及继起的损害不负责任，这些损害来自：不正当使用邮件服务，在网上购买商品或服务，在网上进行交易，非法使用邮件服务或用户传送的信息所变动。</p>
						<h3>8．用户责任</h3>
						...
						<ul>
							...
							<li>（5）遵守所有使用邮件服务的网络协议、规定、程序和惯例。</li>
							<li>（6）不得利用本站危害国家安全、泄露国家秘密，不得侵犯国家社会集体的和公民的合法权益。</li>
						...
						<h3>9．发送通告</h3>
						<p>所有发给用户的通告都可通过电子邮件或常规的信件传送。Spischolar学术资源在线会通过邮件服务发报消息给用户，告诉他们服务条款的修改、服务变更、或其它重要事情。</p>
						<h3>10．网站内容的所有权</h3>
						<p>Spischolar学术资源在线定义的内容包括：文字、数据、图表、软件；在广告中全部内容；电子邮件的全部内容；所有这些内容受版权、商标、标签和其它财产所有权法律的保护。所以，用户只能在Spischolar学术资源在线和广告商授权下才能使用这些内容，而不能擅自复制、篡改这些内容、或创造与内容有关的派生产品。</p>
						<h3>11．附加信息服务</h3>
						<p>用户在享用Spischolar学术资源在线提供的免费服务的同时，同意接受Spischolar学术资源在线提供的各类附加信息服务。</p>
						<h3>12．解释权</h3>
						<p>本注册协议的解释权归Spischolar学术资源在线所有。如果其中有任何条款与国家的有关法律相抵触，则以国家法律的明文规定为准。</p>
					</div>
				</div>
			</div>
		</div>
